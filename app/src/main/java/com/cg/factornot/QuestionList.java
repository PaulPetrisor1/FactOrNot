...
public class QuestionList {
    ...
    public String mQuestions[] = new String[] {"Vending machines kill 4 times as many people as sharks per year. ",
            ...
            "Cracking your knuckles repeatedly causes arthritis.",
            "Chameleons change colour to blend in with their surroundings.",
            "Vikings wore helmets with horns.",
            "If you accidentally swallow gum it takes 7 years to digest it.",
            "Napoleon Bonaparte was very short.",
            "Different parts of your tongue are responsible for different taste buds.",
            "You can see the Great Wall of China from space.",
            "Humans just use 10% of their brain.",
            "You can kill someone by dropping a penny off the top of the Empire State Building.",
            ...
            "Green snot means a bacterial infection and yellow snot a viral one.",
